function theTitle = makeAnimationTitle(alpha, beta, gamma, epsilon0Pull, epsilon0Push, runNumber)
...
if nPull == 1
    ...
    titleLine = [ titleLine [ 'Pulled 1 molecule with f = ' num2str(fPull, '%d') ...
        ...
        sprintf(') over [%d, %d] ps', t0Pull*1000, tfPull*1000) ] ];
...
if nPush == 1
    ...
    titleLine = [ titleLine [ 'Pushed 1 molecule with f = ' num2str(fPush, '%d') ...
        ...
        sprintf(') over [%d, %d] ps', t0Push*1000, tfPush*1000) ] ];
